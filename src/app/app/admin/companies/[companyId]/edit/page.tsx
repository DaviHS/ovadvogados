// src/app/app/admin/companies/[companyId]/edit/page.tsx
"use client"
...
import { companyUpdateSchema, type CompanyUpdateData } from "@/validators/company"
import z from "zod"
...
export default function EditCompanyPage() {
  ...
  const { data: company, isLoading } = api.admin.company.getById.useQuery({ companyId })
  const updateMutation = api.admin.company.update.useMutation()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Validar dados
      companyUpdateSchema.parse(formData)
      ...
      if (error instanceof z.ZodError) {
        ...
        setErrors({ general: "Erro ao atualizar empresa. Tente novamente." })
      }
    }
  }

  const handleInputChange = (field: keyof CompanyUpdateData, value: string | number) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }))
  ...
  if (isLoading) {
    return <div className="min-h-screen flex items-center justify-center">Carregando dados da empresa...</div>
  }
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Atualize os dados da empresa no sistema</CardDescription>
            </CardHeader>
